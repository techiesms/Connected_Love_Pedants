...
if (one_time_only)
 ...
 if (lamp_1_master == 0 && lamp_2_master == 1 && button_flag == 0)
  {
...
repeat:
    ...
    while (counter_flag < 5000)
    {
      ...
      if (digitalRead(touch) ==LOW && counter_flag < 5000)
      {
        delay(1);
        break;
      }
      else if (digitalRead(touch)==HIGH && counter_flag > 5000)      {
  ...
  if (lamp_1_master == 0 && lamp_2_master == 1 && button_flag == 1)
  {
